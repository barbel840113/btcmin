...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return URL_LOGIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ADMIN_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return KRAKENCURRENCY; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return GETUSERSETTINGINFORMATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return UPDATEUSERSETTINGS; });
...
var HOSTAPI = "http://" + apiresoure + "/";
var HOSTIDENTITY = "http://" + identityserver + "/";
...
/***/ "../../../../../src/app/guards/bu-guard.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BusinessUnitGuard; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var BusinessUnitGuard = /** @class */ (function () {
    /**
     *
     * @param appService
     */
    function BusinessUnitGuard(appService) {
     ...
     * @param nextState
     */
    BusinessUnitGuard.prototype.canDeactivate = function (component, currentRoute, currentState, nextState) {
     ...
     * @param state
     */
    BusinessUnitGuard.prototype.canActivate = function (next, state) {
        if (this.appService.profileUserContainer$.value != null && typeof (this.appService) !== 'undefined') {
            var roleName = this.appService.profileUserContainer$.value.role;
            if (roleName == 'Admin') {
                return true;
...
"use strict";
/* unused harmony export TableBasicExample */
...
var ExampleDataSource = /** @class */ (function (_super) {
    ...
    ExampleDataSource.prototype.connect = function () {
        return __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["Observable"].of(data);
    };
...
var BusinessUnitComponent = /** @class */ (function () {
    function BusinessUnitComponent(_formBuilder, formControlService, appSettingsService, dialogService) {
    ...
    BusinessUnitComponent.prototype.onSubmit = function () {
        ...
        if (!(model instanceof Object)) {
            ...
            this.dialogService.openDialog();
            this.appSettingsService.createBusinessUnit(model).subscribe(function (res) {
                if (res.status === 200) {
...
// module
exports.push([module.i, ".mat-drawer-content {\n  height: auto; }\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__guards_bu_guard__ = __webpack_require__("../../../../../src/app/guards/bu-guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'business-unit', component: __WEBPACK_IMPORTED_MODULE_7__business_unit_business_unit_component__["a" /* BusinessUnitComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_8__guards_bu_guard__["a" /* BusinessUnitGuard */]], canDeactivate: [__WEBPACK_IMPORTED_MODULE_8__guards_bu_guard__["a" /* BusinessUnitGuard */]] },
        ]
    }
];
...
var AccountService = /** @class */ (function () {
    ...
    AccountService.prototype.register = function (data) {
        ...
        return this.http.post(__WEBPACK_IMPORTED_MODULE_6__constants_url__["g" /* REGISTER */], data, options)
...
var AppSettingsService = /** @class */ (function () {
     ...
     */
    AppSettingsService.prototype.createBusinessUnit = function (model) {
...
var ApplicationService = /** @class */ (function () {
    ...
    ApplicationService.prototype.getKrakenCurrency = function () {
        var _this = this;
        var url = __WEBPACK_IMPORTED_MODULE_4__constants_url__["f" /* KRAKENCURRENCY */];
    ...
    ApplicationService.prototype.updateUserSettings = function (data) {
        var url = __WEBPACK_IMPORTED_MODULE_4__constants_url__["h" /* UPDATEUSERSETTINGS */];
...
var AuthTokenService = /** @class */ (function () {
    ...
    AuthTokenService.prototype.getTokens = function (data, grantType) {
        ...
        return this.http.post(__WEBPACK_IMPORTED_MODULE_7__constants_url__["i" /* URL_LOGIN */], this.encodeObjectToParams(data), options)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__guards_bu_guard__ = __webpack_require__("../../../../../src/app/guards/bu-guard.ts");
    ...
    ServicesModule.forRoot = function () {
        return {
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__guards_bu_guard__["a" /* BusinessUnitGuard */],
...
var SettingsService = /** @class */ (function () {
    ...
    SettingsService.prototype.getUserInformationSettings = function () {
        var url = __WEBPACK_IMPORTED_MODULE_2__constants_url__["e" /* GETUSERSETTINGINFORMATION */];
